  ...
  return (
    <Box>
      ...
      <Box marginTop={'20px'}>
        ...
        <Text marginTop={'20px'}>
          I also like learning new languages, such as Japanese and Korean.
          I&apos;m more experienced in Japanese Language but I studied abroad in
          Korea so I also have enough knowledge. 🍙
        </Text>
      </Box>
    </Box>
  );
